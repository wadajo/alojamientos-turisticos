...
public interface HotelRuralDocumentMapper extends Converter<AlojamientoTuristico.HotelRural, AlojamientoDocument> {
    ...
    @Override
    AlojamientoDocument convert(AlojamientoTuristico.HotelRural hotelRural);
