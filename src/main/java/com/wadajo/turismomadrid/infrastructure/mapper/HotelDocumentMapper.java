...
public interface HotelDocumentMapper extends Converter<AlojamientoTuristico.Hotel, AlojamientoDocument> {
    ...
    @Mapping(target = "alojamiento_tipo", constant = "Hotel")
    @Mapping(target = "timestamp", expression = "java(java.time.LocalDateTime.now())")
    @Override
    AlojamientoDocument convert(AlojamientoTuristico.Hotel hotel);
