...
public interface HotelDocumentMapper extends Converter<AlojamientoTuristico.Hotel, HotelDocument> {
    ...
    @Override
    HotelDocument convert(@Nonnull AlojamientoTuristico.Hotel hotel);
