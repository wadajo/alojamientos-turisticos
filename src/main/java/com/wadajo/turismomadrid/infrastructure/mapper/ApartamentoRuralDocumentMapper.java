...
public interface ApartamentoRuralDocumentMapper extends Converter<AlojamientoTuristico.ApartamentoRural, ApartamentoRuralDocument> {
    ...
    @Override
    ApartamentoRuralDocument convert(@Nonnull AlojamientoTuristico.ApartamentoRural apartamentoRural);
