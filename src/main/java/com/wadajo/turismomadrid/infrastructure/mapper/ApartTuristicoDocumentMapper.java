...
public interface ApartTuristicoDocumentMapper extends Converter<AlojamientoTuristico.ApartTuristico, ApartTuristicoDocument> {
    ...
    @Override
    ApartTuristicoDocument convert(@Nonnull AlojamientoTuristico.ApartTuristico apartTuristico);
