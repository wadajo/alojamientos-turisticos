...
public interface HostalDocumentMapper extends Converter<AlojamientoTuristico.Hostal, AlojamientoDocument> {
    ...
    @Override
    AlojamientoDocument convert(AlojamientoTuristico.Hostal hostal);
