...
public interface HotelApartDocumentMapper extends Converter<AlojamientoTuristico.HotelApart, AlojamientoDocument> {
    ...
    @Override
    AlojamientoDocument convert(AlojamientoTuristico.HotelApart hotelApart);
